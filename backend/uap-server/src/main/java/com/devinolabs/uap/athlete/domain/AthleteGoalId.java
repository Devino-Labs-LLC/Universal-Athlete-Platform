...
public final class AthleteGoalId {
	...
	public static AthleteGoalId generate() {
		return new AthleteGoalId(UUID.randomUUID());
	}
	...
	public static AthleteGoalId of(String value) {
		Objects.requireNonNull(value, "AthleteGoalId value must not be null");
		return new AthleteGoalId(UUID.fromString(value));
	}
