      ...
      <tbody>
        {definitions.map((definition) => (
          <tr key={definition.id}>
            ...
            <td>{EXERCISE_CATEGORY_LABELS[definition.metadata.category] ?? definition.metadata.category}</td>
            <td>{METRIC_MODE_LABELS[definition.metadata.metricMode] ?? definition.metadata.metricMode}</td>
