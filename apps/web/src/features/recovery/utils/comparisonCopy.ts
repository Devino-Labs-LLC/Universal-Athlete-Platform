import { comparisonBandLabel, metricTypeLabel } from '@/features/recovery/models/labels';

export function deviationSummaryCopy(metricType: string, comparisonBand: string): string {
