...
import { fetchSubstitutionCandidates } from '@/src/features/adaptation/api/substitutionApi';
...
export function useSubstitutionCandidates(
  ...
  return useQuery({
    ...
    queryFn: () =>
      fetchSubstitutionCandidates(apiClient, planId, dayId, occurrenceId, executionId),
    enabled:
      enabled &&
