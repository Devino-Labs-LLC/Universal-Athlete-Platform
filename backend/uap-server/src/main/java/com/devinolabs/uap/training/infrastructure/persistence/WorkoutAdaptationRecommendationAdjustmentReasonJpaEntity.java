...
import com.devinolabs.uap.training.infrastructure.persistence.WorkoutAdaptationRecommendationAdjustmentReasonJpaEntity.Pk;

@Entity
@Table(name = "workout_adaptation_recommendation_adjustment_reasons")
@IdClass(Pk.class)
class WorkoutAdaptationRecommendationAdjustmentReasonJpaEntity {
	...
	protected WorkoutAdaptationRecommendationAdjustmentReasonJpaEntity() {
	}

	TrainingRecommendationReasonCode getReasonCode() { return reasonCode; }
	int getOrderIndex() { return orderIndex; }

	static WorkoutAdaptationRecommendationAdjustmentReasonJpaEntity of(
			WorkoutAdaptationRecommendationAdjustmentJpaEntity adjustment,
			TrainingRecommendationReasonCode reasonCode,
			int orderIndex) {
		WorkoutAdaptationRecommendationAdjustmentReasonJpaEntity entity =
				new WorkoutAdaptationRecommendationAdjustmentReasonJpaEntity();
