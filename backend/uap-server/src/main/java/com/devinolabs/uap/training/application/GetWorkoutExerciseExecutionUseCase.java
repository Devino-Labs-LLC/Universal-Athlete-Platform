...
@Service
public class GetWorkoutExerciseExecutionUseCase {
	...
	public GetWorkoutExerciseExecutionUseCase(
	...
	public WorkoutExerciseExecutionResult execute(
		...
		WorkoutExerciseExecutionSupport.requireOwnedOccurrence(
				workoutOccurrenceRepository, occurrenceId, day.id(), athleteId);
		return WorkoutExerciseExecutionSupport.toResult(
				WorkoutExerciseExecutionSupport.requireOwnedExecution(
