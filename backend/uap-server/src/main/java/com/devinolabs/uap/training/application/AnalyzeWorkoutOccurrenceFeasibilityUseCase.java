...
@Service
public class AnalyzeWorkoutOccurrenceFeasibilityUseCase {
	...
	public AnalyzeWorkoutOccurrenceFeasibilityUseCase(
	...
	public WorkoutOccurrenceFeasibilityResult execute(
			AccountId accountId,
		...
		return feasibilityAnalyzer.analyzeOccurrence(
				plan,
				day,
				occurrence,
				athleteId,
