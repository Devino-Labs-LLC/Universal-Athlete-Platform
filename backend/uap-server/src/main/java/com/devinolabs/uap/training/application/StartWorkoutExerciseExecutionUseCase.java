...
@Service
public class StartWorkoutExerciseExecutionUseCase {
	...
	public WorkoutExerciseExecutionResult execute(
		...
		// SCHEDULED parents are atomically promoted to IN_PROGRESS when a child starts.
		WorkoutExerciseExecutionSupport.ensureOccurrenceInProgress(
				occurrence, workoutOccurrenceRepository, clock);
