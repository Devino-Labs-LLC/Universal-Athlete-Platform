...
export type AthleteExercisePerformanceHistory = z.infer<
  typeof athleteExercisePerformanceHistorySchema
>;
...
export const trainingLoadGranularitySchema = z.enum(['OCCURRENCE', 'DAILY', 'WEEKLY']);
